...
# pixels large.
html_favicon = '_static/torsync.ico'
...
#----------------------------
# Advanced processing....
#def skip_specified_members(app, what, name, obj, skip, options):
#    """
#    Provides ability to skip specified members because they are part
...
#       print('Inputs:\n[%s:%s:%s:%s]' % (what, name, obj, skip))
#   if what == 'class' and name == 'objects' and obj is None:
#       print('Inputs:\n[%s:%s:%s:%s]' % (what, name, obj, skip))
#       print('Skip Entry!!!')
#       return True
#
#   if what == 'class' and name in ['created',
#                                   'modified',
#                                   'timestamp'] and obj is None:
#       print('Inputs:\n[%s:%s:%s:%s]' % (what, name, obj, skip))
#       print('Skip Entry!!!')
#       return True
#
...
#
#def setup(app):
#    app.connect('autodoc-skip-member', skip_specified_members)
#
